...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIwMDUwNjExMTUxMzEwOTcyNzU=";//승인키
	// resultType항목 추가(2016.10.06)
	var resultType = "4"; // 도로명주소 검색결과 화면 출력유형, 1 : 도로명, 2 : 도로명+지번, 3 : 도로명+상세건물명, 4 : 도로명+지번+상세건물명
	var inputYn= "<%=inputYn%>";
	if(inputYn != "Y"){
		document.form.confmKey.value = confmKey;
		document.form.returnUrl.value = "http://192.168.10.84:8000/sample";
		document.form.resultType.value = "3"; // resultType항목 추가(2016.10.06)
